...
class BipedRlEnvCfg(ManagerBasedRLEnvCfg):
    ...
    scene: BipedRlSceneCfg = BipedRlSceneCfg(num_envs=500, env_spacing=0.2)
    ...
    def __post_init__(self) -> None:
        ...
        self.episode_length_s = 5.0  # seconds
        self.viewer.eye = (0.1, 0.0, 0.025)
